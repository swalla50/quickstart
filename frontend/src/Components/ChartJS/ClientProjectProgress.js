...
function ClientProjectProgress(props) {
                ...
                (
                    <>
                        {data.CompletedProjects == 0 || data.length == 0?
                            ...
                            :
                            (
                                <div style={{ width: '20rem', height: '20rem' }} className='PieChartClientProject'>
                                    <p className='project-client-percent'>{data.ProjectPercent}%</p>
                                    <Doughnut options={chartOptions} height={10} data={chartData} />
                                    <p  style={{color:'white'}}className='project-client-total'>{data.AllProjects} Projects</p>
                                </div>
                            )
