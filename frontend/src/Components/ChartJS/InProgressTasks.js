                        ...
                        {data.CompletedTasks == 0 || data.length == 0?
                            (
                                ...
                                <div  style={{ width: '100%', height: '20rem' }} className='no-projdata'>
                                   <h7 style={{color:'black'}}>0 Task Progress For This Client</h7><Button className='no-inv-button' href='project'>Add Project</Button>
                                </div>
                            )
                            :
                            (
                                <div style={{ width: '20rem', height: '20rem',color:'black' }} className='PieChartClientTask'>
                                    <p style={{color:'black'}} className='project-client-percent'>{data.Percent}%</p>
                                    <Doughnut options={chartOptions} height={10} data={chartData} />
                                    <p  style={{color:'black'}}className='project-client-total'>{data.AllTasks} Tasks</p>
                                </div>
                            )
