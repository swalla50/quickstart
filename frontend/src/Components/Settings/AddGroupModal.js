...
import { faBuilding, faBuildingCircleArrowRight, faBuildingCircleCheck, faCode, faContactBook, faLayerGroup, faPalette, faPallet, faPeopleGroup, faPerson, faPhoneSquare, faPlus, faUserGroup, faVoicemail } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className='RestockModal'>
            ...
            >
                ...
                <Modal.Header closeButton>
                    Add a New Group <FontAwesomeIcon className="excel-icon" icon={faPeopleGroup} size='1x' />
                </Modal.Header>
                <Modal.Body>
