                ...
                .then((res) => {
                    ...
                    axios.get(`getvendor/getvendorList`)
                        .then((response) => {
                            ...
                            setImgData('https://webapi20220126203702.azurewebsites.net/api/blobexplorer/GetBlobFile?url=' + 'https://altbooksblob.blob.core.windows.net/profilepicscpntainer/Placeholder_view_vector.png')
    ...
    function submitedNewCompany() {
        ...
        axios.post("https://webapi20220126203702.azurewebsites.net/api/blobexplorer/uploadblobfile", formData)
            .then(res => {
                ...
                axios.post(`AddVendor/AddVendor`, editcomven)
                    .then((response) => {
                        // console.log('newvencom POST', response.data)
                    ...
                    <Form className='addcomven-form'>
                        ...
                        <div className='addvencom-inputs-container'>
                            <div onClick={clickImage} style={{ width: '100%' }} className='sender-logo1'>
                                <input id="profile-image-upload2" onChange={onChangePicture} type="file" className='hidden invoice-image-upload'>

                                </input>
                                <img style={{ borderRadius: '50px', border: 'solid #0d6efd 3px', boxShadow: '0px 6px 20px 0px rgb(0 0 0 / 30%)' }} id="profile-image2" className='sender-logo-img' src={imgData} />
                                ...
                                <Tab eventKey="General" title="INFO" className="7-day-tab">
                                    <div className='vencom-form-columns-container'>
                                        <div className='left-vencom-form'>
                                            ...
                                            <Form.Control  required onChange={(e) => { onvendorNameChange(e.target.value); e.preventDefault() }} type='text' className='addvencom-input'></Form.Control>
                                            <Form.Label className='addvencom-label'> Type <FontAwesomeIcon className="excel-icon" icon={faPalette} size='1x' /> </Form.Label>
                                            <Form.Select  required onChange={(e) => onvendorTypeChange(e.target.value)} type='text' className='addvencom-input'>
                            ...
                            <Form.Control defaultValue={Company[0].itemCode} onChange={(e) => onvendorcodeItemChange(e.target.value)} type='text' className='addvencom-input'></Form.Control> */}
                                            ...
                                            <Form.Control required onChange={(e) => onvendorEmailChange(e.target.value)} type='email' className='addvencom-input'></Form.Control>
                                            <Form.Label className='addvencom-label'> Phone <FontAwesomeIcon className="excel-icon" icon={faPhoneSquare} size='1x' /></Form.Label>
                                            <Form.Control required onChange={(e) => onvendorPhoneChange(e.target.value)} type='phone' className='addvencom-input'></Form.Control>
                                            <Form.Label className='addvencom-label'> Country <FontAwesomeIcon className="excel-icon" icon={faMapLocation} size='1x' /> </Form.Label>
                                            <Form.Select required  onChange={(e) => { setSelectedCountry(JSON.parse(e.target.value)); setvenCountry(e.target.value) }} type='text' className='addvencom-input'>
                                            ...
                                            <Form.Select required onChange={(e) => { setSelectedState(JSON.parse(e.target.value)); setvenState(e.target.value) }} type='text' className='addvencom-input'>
                                                <option value={null}></option>
                                        ...
                                        <div className='right-vencom-form'>
                                            ...
                                            <Form.Select required onChange={(e) => { setSelectedCity(JSON.parse(e.target.value)); setvenCity(e.target.value) }} type='text' className='addvencom-input'>
                                                <option value={null}></option>
                                            ...
                                            <Form.Control  onChange={(e) => onstreetChange(e.target.value)} type='text' className='addvencom-input'></Form.Control>


                                            <Form.Label className='addvencom-label'> Zip Code <FontAwesomeIcon className="excel-icon" icon={faMapLocation} size='1x' /></Form.Label>
                                            <Form.Control  onChange={(e) => onzipChange(e.target.value)} type='text' className='addvencom-input'></Form.Control>
                                            <Form.Label className='addvencom-label'> Currency <FontAwesomeIcon className="excel-icon" icon={faCoins} size='1x' /> </Form.Label>
                                            <Form.Select  onChange={(e) =>{ oncurrencyChange(e.target.value);setvenCurrency(e.target.value)}} type='text' className='addvencom-input'>
                                                <option value={null}></option>
                                                {unique.map(i => (
                            ...
                            <Button onClick={submitedNewCompany} className='addnewVendCom-btn'>Submit</Button>
