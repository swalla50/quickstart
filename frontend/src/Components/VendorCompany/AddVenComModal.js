                ...
                <Modal.Body>
                    <Form className='addcomven-form'>
                        <div className='addvencom-header'>
                            <h4 className='ComVenModal-header'>Please add a new Vendor/Company</h4>
                        </div>
                        <div className='addvencom-inputs-container'>
                            ...
                            <Form.Control onChange={(e) => { setvenName(e.target.value); e.preventDefault() }} type='text' className='addvencom-input'></Form.Control>
                            <Form.Label className='addvencom-label'> Type <FontAwesomeIcon className="excel-icon" icon={faPalette} size='1x' /> </Form.Label>
                            <Form.Select defaultValue={'1'} onChange={(e) => setvenType(e.target.value)} type='text' className='addvencom-input'>
                            ...
                            <Form.Check onChange={(e) => setvendorbool(e.target.checked)} type='checkbox' className='addvencom-input'></Form.Check>
